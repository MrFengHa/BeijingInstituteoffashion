<template>
  <div>
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm"
      ...
      <el-form-item ref="upload_attach_item" label="展示图片" prop="image" size='small'>
      ...
      <el-form-item ref="upload_attach_item" label="中文配音" prop="cnAudio">
        <el-upload style="float: left"
                   ref="upload_attach"
                   class="upload-demo"
                   action="http://localhost:8080/manager/addExhibits"
      ...
      <el-form-item label="英文配音" prop="enAudio">
        <el-upload style="float: left"
                   ref="upload_attach"
                   class="upload-demo"
                   action="http://localhost:8080/manager/addExhibits"
  ...
  export default {
    ...
    data() {
      ...
      var validateAttach = (rule, value, callback) => {
        ...
        console.log(this.imageFileList.length)
        console.log(this.cnAudioFileList.length)
        console.log(this.enAudioFileList.length)
      ...
      return {
        ...
        rules: {
          ...
          image: [
            ...
            {required: true,validator: validateAttach}
          ],
          cnAudio: [
    ...
    methods: {
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
           ...
           data.append("image",this.imageFileList[0]);
           data.append("cnAudio",this.cnAudioFileList[0]);
           data.append("enAudio",this.enAudioFileList[0]);
      ...
      uploadSectionFile(param) {
        ...
        this.ruleForm.image= param.file // 将form中的files字段赋值File对象
