package com.heiyou.util;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.heiyou.config.WeiXinConfig;
import com.heiyou.entity.weixin.*;
...
public class WeiXinUtil {
    ...
    public String getAccessToken() {
        ...
        if (StringUtils.isEmpty(accessToken)) {
            String response = com.heiyou.util.HttpUtil.get("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=" + weiXinConfig.getAppid() + "&secret=" + weiXinConfig.getAppsecret());
    ...
    public WeiXinTokenAuth getAccessTokenAuth(String code) {
        ...
        if (StringUtils.isEmpty(accessTokenJson)) {
            ...
            String response = com.heiyou.util.HttpUtil.get("https://api.weixin.qq.com/sns/oauth2/access_token?appid=" + weiXinConfig.getAppid()
    ...
    public boolean sendTemplateMessage(String toUser, String templateId, String url, Object data) {
        ...
        String response = com.heiyou.util.HttpUtil.post("https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=" + getAccessToken(), JSON.toJSONString(templateMessage));
    ...
    public boolean createMenu(WeiXinMenu menu) {
        ...
        String response = com.heiyou.util.HttpUtil.post("https://api.weixin.qq.com/cgi-bin/menu/create?access_token=" + getAccessToken(), postData);
        JSONObject jsonObject = JSONObject.parseObject(response);
        System.out.println(response);
        return jsonObject.getInteger("errcode") == 0;
    }
    ...
    public WeiXinUserInfoAuth getUserInfoAuth(String accessToken, String openId) {
        String response = com.heiyou.util.HttpUtil.get("https://api.weixin.qq.com/sns/userinfo?access_token=" + accessToken + "&openid=" + openId + "&lang=zh_CN");
    ...
    public WeiXinUserInfo getUserInfo(String openId) {
        String response = com.heiyou.util.HttpUtil.get("https://api.weixin.qq.com/cgi-bin/user/info?access_token=" + getAccessToken() + "&openid=" + openId + "&lang=zh_CN");
